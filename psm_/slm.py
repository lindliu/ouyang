...
if __name__=="__main__":
    ...
    # status_name = 'sln1'
    # feature_name = ['liverm', 'peritoneum', 'spleenm', 'gender', 'age0',\
    #                 'kps90', 'pcsize', 'ca199', 'sctr', 'ldh', 'alb0',"hb",\
    #                 'pain']
    # # feature_name = ['lungm', 'bonem']
    ...
    # results = T_C_nearest_match(status, propensity_score, threshold=0.001, crop=156)
    ...
    data_file = '1369mapc'
    df = pd.read_stata(f'./data_sln/{data_file}.dta')
    df = df.drop(['_st', '_d', '_t', '_t0'], axis=1)
    # df.loc[df['age0']>=65, 'age0'] = 1
    # df.loc[df['age0']<65, 'age0'] = 0
    
    status_name = 'sln1'
    feature_name = ['liverm', 'peritoneum', 'spleenm', 'gender', 'age0',\
                    'kps90', 'pcsize', 'ca199500', 'sctr', 'ldh', 'alb0',"hb",\
                    'pain']
    feature, status = get_data(df, feature_name, status_name)    
    ...
    ### match the treatment and control
    # results = T_C_match(status, propensity_score, k=10, threshold=0.05, round_=2)
    results = T_C_nearest_match(status, propensity_score, threshold=0.001, crop=200).flatten()
    ...
    while flag:
        ...
        # anova_list = ['gender', 'kps90', 'concur', 'pcsize5', 'pcloca', \
        #             'lmextent1', 'peritoneum', 'spleenm', 'wbc10',\
        #             'pain', 'ascites1', 'wl10', 'ca199500', 'cea10', 'alb35', \
        #             'tb24', 'cb7', 'ldh250', 'alt60', 'ast60',\
        #             'hb120', 'alp130', 'resected', 'sctr', 'tace']
        anova_list = ['gender', 'kps80', 'pcloca', \
                      'age65', 
                    'peritoneum', 'wbc',\
                    'pain', 'ca199500', 'cea10', 'alb35', \
                    'tb', 'ldh', 'ca24220',\
                    'sctr', 'liverm']
    ...
    fig.suptitle('Distributional of Propensity Scores', fontsize=25)
